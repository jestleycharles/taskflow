...
/** Default demo team for guest accounts — cannot be deleted. */
...
function toSessionUser(user) {
  ...
  sessionUser.is_feedback_admin = isFeedbackAdmin(sessionUser);
  return sessionUser;
}
...
function isGuestProtectedTeamId(teamId) {
  return teamId === GUEST_PROTECTED_TEAM_ID;
}

module.exports = {
  GUEST_EMAIL,
  GUEST_PROTECTED_TEAM_ID,
